...
const sidebarHandler = ()=>{
  ...
  <svg onClick={sidebarHandler} className='menu' fill={theme==='dark'?'aliceblue':'#484848'} height="32" viewBox="0 0 24 24" width="32" xmlns="http://www.w3.org/2000/svg"><path class="heroicon-ui" d="M4 5h16a1 1 0 0 1 0 2H4a1 1 0 1 1 0-2zm0 6h16a1 1 0 0 1 0 2H4a1 1 0 0 1 0-2zm0 6h16a1 1 0 0 1 0 2H4a1 1 0 0 1 0-2z"/></svg>
   <div>
   {questionId && <FaTrash
    style = {{
